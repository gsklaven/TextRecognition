...
dfs_letters = extract_letters(binary_img, dfs_sorted_boxes)
...
cc_letters = extract_letters(binary_img, cc_sorted_boxes)
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, f"text_recognition_results1.png"))
